        ...
        for layer in self:
            if isinstance(layer, ResBlock):
                ...
                x = layer(x,
                          ...
                          injection_config,injection_maps)
            else:
                x = layer(x)
...
class UNetModel(nn.Module):
    ...
    def forward(self,
        ...
        module_i = 0
        # print(x.shape) #torch.Size([1, 4, 64, 64])
        for module in self.output_blocks:
            ...
            x_feature_key = f'output_block_{module_i}_self_attn_x'
            ...
            if injected_features is not None and x_feature_key in injected_features:
                self_attn_x_injected = injected_features[x_feature_key]
            ...
            if injected_features is not None:
                ...
                injection_maps = injection_config['sem_maps']
