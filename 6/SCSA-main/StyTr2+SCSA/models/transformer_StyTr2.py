...
class Transformer(nn.Module):
    ...
    def forward(self, style, mask , content, pos_embed_c, pos_embed_s, args):
        ...
        hs = self.decoder(content, style, args, memory_key_padding_mask=mask,
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,args,
        ...
        i = 0 
        for layer in self.layers:
            output = layer(output, memory,  args, i, tgt_mask=tgt_mask,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, args,i,
                tgt_mask: Optional[Tensor] = None,
                memory_mask: Optional[Tensor] = None,
                tgt_key_padding_mask: Optional[Tensor] = None,
                memory_key_padding_mask: Optional[Tensor] = None,
        ...
        return self.forward_post(tgt, memory, tgt_mask, args, i, memory_mask,
