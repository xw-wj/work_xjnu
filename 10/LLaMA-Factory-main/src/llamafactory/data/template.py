...
# Stable Code Instruct 3B 模板
register_template(
    name="stable_code",
    format_user=StringFormatter(
        slots=[{"bos_token"}, "### Instruction:\n{{content}}\n\n### Response:\n"]
    ),
    format_assistant=StringFormatter(
        slots=["{{content}}", {"eos_token"}, "\n\n"]
    ),
    format_system=StringFormatter(
        slots=[{"bos_token"}, "{{content}}\n\n"]
    ),
    default_system=(
        "You are a helpful and expert programming assistant. You provide clear, efficient, "
        "and well-documented code solutions. You explain your reasoning and follow best practices. "
